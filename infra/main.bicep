...
var apiUsesPlaceholder = apiImage == placeholderImage
var tags = {
...
module backend 'core/host/container-app.bicep' = {
  ...
  params: {
    ...
    targetPort: apiUsesPlaceholder ? 80 : 8080
    probePath: apiUsesPlaceholder ? '/' : '/healthz'
    maxReplicas: 1
    env: [
      {
...
resource sreAgentAdministrator 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: sreAgent
